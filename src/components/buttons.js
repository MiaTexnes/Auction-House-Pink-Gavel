...
export function createLoadMoreButton(
  ...
  if (id) btn.id = id;
  btn.textContent = text;
  btn.className = `bg-pink-500 hover:bg-pink-600 text-white font-semibold py-3 px-8 rounded-lg transition-all shadow-md transform hover:scale-105 ${additionalClasses}`;
